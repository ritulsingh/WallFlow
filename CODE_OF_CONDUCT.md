...
issues, pull requests, discussions, and any other project-related forum —
...
reported by [opening an issue](https://github.com/ritulsingh/WallFlow/issues/new)
or by contacting the maintainer through their
[GitHub profile](https://github.com/ritulsingh). If the report concerns a
maintainer, or you would prefer not to raise it publicly, GitHub also lets
you [report the content or user directly](https://github.com/contact/report-content)
to GitHub.
